...
utilities_get_struct.o: utilities_get_struct.f90 al_defs.o al_low_level_wrap.o ids_utilities.o
	$(FC) -c $(FCFLAGS) $(MODINC) $< -o $@
utilities_validate_struct.o: utilities_validate_struct.f90 al_defs.o al_low_level_wrap.o ids_utilities.o
	$(FC) -c $(FCFLAGS) $(MODINC) $< -o $@

$(filter %_put.o,$(IDSOBJECTS)): %_put.o : %_put.f90 %_delete.o %_schema.o %_validate.o utilities_put_struct.o al_defs.o al_low_level_wrap.o
	$(FC) -c $(FCFLAGS) $(MODINC) $< -o $@
...
%_schema.o: %_schema.f90 al_defs.o ids_types.o ids_utilities.o
	$(FC) -c $(FCFLAGS) $(MODINC) $< -o $@
%_validate.o: %_validate.f90 al_defs.o ids_types.o ids_utilities.o %_schema.o utilities_validate_struct.o
	$(FC) -c $(FCFLAGS) $(MODINC) $< -o $@
